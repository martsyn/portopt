...
class MC_OAuth2Client extends OAuth2Client {
    ...
    public function __construct() {
        ...
        $base =  'api.hfinone.com';   //your host
        $path = '/mailchimp/complete.php'; //the path on your host
            
        $client_id = '755469067161';   //client_id from creating app in MC (see README)
        $client_secret = 'b7cf12433cb3939b40fbf2edf45f341c'; //client_secret from creating app in MC  (see README)
